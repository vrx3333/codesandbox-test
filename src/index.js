...
// sayHello(); // ↑ 引数の中に=〇〇で宣言されている場合、初期値が代入されている。
// sayHello("ジャケ");
...
// const sumFunc2 = (num1, num2, num3, num4, num5) =>
...
// arr8[0] = 100;
// console.log(arr8);
// console.log(arr4); // = で入れてしまうと元のarr4も値が変わってしまうため、...を使った方が良い
